...
import type { OrgReturnRateBreakdown } from '@/services/admin-dashboard.service'
...
interface OrgReturnRateChartProps {
  data: OrgReturnRateBreakdown
}

export function OrgReturnRateChart({ data }: OrgReturnRateChartProps) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#dddddd] p-5 flex flex-col">
      <div className="mb-1">
        <h2 className="text-sm font-semibold text-[#222222]">Organisation Return Rate</h2>
        <p className="text-xs text-[#929292] mt-0.5">All items ever logged by your organisation</p>
      </div>
