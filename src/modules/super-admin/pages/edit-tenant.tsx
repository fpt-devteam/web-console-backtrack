 ...
 * Edit Tenant Page
 * 
 * Form page for editing an existing tenant account.
 */
export function EditTenantPage() {
  const router = useRouter();
  const { tenantId } = useParams({ from: '/super-admin/edit-tenant/$tenantId' });
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    showToast.success(`Tenant "${formData.name}" updated successfully!`);
