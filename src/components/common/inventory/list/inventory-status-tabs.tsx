import { inventoryStatusLabel } from '../detail/inventory-status'
      ...
      {TABS.map((t) => {
        ...
        return (
          <button
            ...
            onClick={() => onChange(t)}
            className={[
              'cursor-pointer px-3 py-1.5 rounded-lg border text-xs font-medium transition-all whitespace-nowrap active:scale-[0.97] sm:px-4 sm:py-2 sm:text-sm',
              active
