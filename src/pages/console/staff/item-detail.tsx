...
import { HandoverItemModal } from '@/components/console/staff/handover-item-modal'
import { ArchiveConfirmModal } from '@/components/console/staff/archive-confirm-modal'
          ...
          item ? (
            <>
              <HandoverItemModal
                ...
                onSuccess={() => {
                  void navigate({ to: `/console/${slug}/staff/item/${item.id}`, replace: true } as any)
                }}
              />
              <ArchiveConfirmModal
                open={archiveOpen}
