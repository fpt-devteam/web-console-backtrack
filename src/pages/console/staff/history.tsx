...
import { IntakeHistory } from '@/components/console/staff/history-tabs/intake-history'
import { HandoverHistory } from '@/components/console/staff/history-tabs/handover-history'
