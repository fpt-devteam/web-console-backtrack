...
import { MessageCircle, Package, Search, Users } from 'lucide-react'
import { PostStatusBreakdownChart } from '@/components/console/staff/dashboard/post-status-breakdown-chart'
import { RecentItemsPanel } from '@/components/console/staff/dashboard/recent-items-panel'
import { StatCard } from '@/components/console/staff/dashboard/stat-card'
...
import { StaffDashboardMockPage } from './staff-dashboard-mock.page'
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <StatCard
            ...
            value={postStats?.foundPosts ?? '—'}
            sub={`${postStats?.foundThisMonth ?? 0} total logged by me`}
            icon={Search}
            iconBg="bg-[#f0f4ff]"
          ...
          <StatCard
            ...
            sub={`${stats?.totalReturns ?? 0} total returned by me`}
            icon={Users}
            iconBg="bg-[#e8f9f0]"
