...
import { InventoryPhotosPicker } from '@/components/common/inventory/photos/inventory-photos-picker'
...
export function EditInventoryPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      navigate({ to: `/console/${slug}/staff/inventory/${item.id}/` })
    } catch (e) {
    ...
    <div className="p-4 sm:p-6 lg:p-8">
        <div className="max-w-5xl xl:max-w-6xl 2xl:max-w-[96rem] mx-auto">
          <div className="mb-6 flex items-center gap-2 text-sm text-[#6a6a6a]">
            ...
            <Link to="/console/$slug/staff/inventory/$itemId" params={{ slug, itemId }} className="hover:text-[#222222] transition-colors">
